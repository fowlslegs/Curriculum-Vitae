...
\renewcommand*{\mobilephonesymbol}{\\\makeIcon{phone}\hfill}
\phone[mobile]{+41~78~889~97~85}
\renewcommand*{\emailsymbol}{\makeIcon{email}\hfill}
\email{tenchi@team2xh.net}
\renewcommand*{\homepagesymbol}{\makeIcon{home}\hfill}
\homepage{tenchi.team2xh.net}
\renewcommand*{\githubsocialsymbol}{\makeIcon{github}\hfill}
\social[github][github.com/Tenchi2xh]{github.com/Tenchi2xh}
\extrainfo{\includegraphics[width=4cm]{picture} \vspace{-1cm}}

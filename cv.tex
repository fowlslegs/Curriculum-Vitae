...
\textbf{Security.} libsodium, Tor, IPTables, OSSEC, tcpdump/ Wireshark
...
{}
{Hampshire College}
{\emph{McEliece-Type Cryptosystems as Post-Quantum Standards}\hfill
  \makeIcon{github}\href{https://github.com/nvesely/McEliece-Type-Cryptosystems-Report}{/McEliece}\\
...
%------------------------------------------------
  \emph{An Evolved Cryptographic Compression Function}\hfill
  \makeIcon{github}\href{https://github.com/nvesely/Clojush-Compression-Function}{/Compression-Function}\\
